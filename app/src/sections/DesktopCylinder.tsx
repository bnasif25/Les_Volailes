...
export default function DesktopCylinder() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const radius = 3.2;
      const imageCount = 15;
      geometry = new THREE.PlaneGeometry(1.2, 1.8, 16, 16);
      materials = [];
  ...
  if (webglFailed) {
    return (
      <div className="py-24 px-6 bg-ivory text-center">
      ...
      <div className="sticky top-0 h-screen overflow-hidden bg-ivory">
        ...
        >
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(248,243,232,0.7) 0%, rgba(248,243,232,0.3) 50%, transparent 80%)',
            }}
          />
